...
class Vehicle6StatusReader(BaseReader):
    arbitration_id = 1537
    ...
    def read_input_data(self):
        ...
        vs6 = self._binary_data
        self._global_data.set_data_status_vehicle6(binaryToDecimal(int(vs6[0])))
        vehicle_status6 = binaryToDecimal(int(vs6[0]))
        ...
        tag_vol6 = binaryToDecimal(int(vs6[2] + vs6[1]))
        target_volatge_from_car6 = (tag_vol6 / 10)

        tag_curr6 = binaryToDecimal(int(vs6[4] + vs6[3]))
        target_current_from_car6 = (tag_curr6 / 10)
        
        target_power6 = int(target_volatge_from_car6 * target_current_from_car6)
        self._global_data.set_data_targetpower_ev6(target_power6)
        ...
        if vehicle_status2 == 13 and vehicle_status1_g == 0 or vehicle_status2 == 13 and vehicle_status1_g == 6:
            PECC.STATUS1_GUN2_DATA[2] = binaryToDecimal(int(vs6[2]))
            PECC.STATUS1_GUN2_DATA[1] = binaryToDecimal(int(vs6[1]))
            PECC.STATUS1_GUN2_DATA[3] = binaryToDecimal(int(vs6[3]))
            PECC.STATUS1_GUN2_DATA[4] = binaryToDecimal(int(vs6[4]))
            ...
            if 0 < maxpowerev2_g <= 30000:
                ...
                cable_check_voltage2 = binaryToDecimal(int(vs6[7] + vs6[6]))
