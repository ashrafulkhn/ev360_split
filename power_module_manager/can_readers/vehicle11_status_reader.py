...
class Vehicle11StatusReader(BaseReader):
    arbitration_id = 2817
    ...
    def read_input_data(self):
        ...
        vs11 = self._binary_data
        self._global_data.set_data_status_vehicle11(binaryToDecimal(int(vs11[0])))
        vehicle_status11 = binaryToDecimal(int(vs11[0]))
        ...
        tag_vol11 = binaryToDecimal(int(vs11[2] + vs11[1]))
        target_volatge_from_car11 = (tag_vol11 / 10)

        tag_curr11 = binaryToDecimal(int(vs11[4] + vs11[3]))
        target_current_from_car11 = (tag_curr11 / 10)
    
        target_power11 = int(target_volatge_from_car11 * target_current_from_car11)
        self._global_data.set_data_targetpower_ev11(target_power11)
        ...
        if vehicle_status2 == 13 and vehicle_status1_g == 0 or vehicle_status2 == 13 and vehicle_status1_g == 6:
            PECC.STATUS1_GUN2_DATA[2] = binaryToDecimal(int(vs11[2]))
            PECC.STATUS1_GUN2_DATA[1] = binaryToDecimal(int(vs11[1]))
            PECC.STATUS1_GUN2_DATA[3] = binaryToDecimal(int(vs11[3]))
            PECC.STATUS1_GUN2_DATA[4] = binaryToDecimal(int(vs11[4]))
            ...
            if 0 < maxpowerev2_g <= 30000:
                ...
                cable_check_voltage2 = binaryToDecimal(int(vs11[7] + vs11[6]))
