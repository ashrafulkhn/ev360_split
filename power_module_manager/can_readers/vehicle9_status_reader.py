...
class Vehicle9StatusReader(BaseReader):
    arbitration_id = 2305
    ...
    def read_input_data(self):
        ...
        vs9 = self._binary_data
        self._global_data.set_data_status_vehicle9(binaryToDecimal(int(vs9[0])))
        vehicle_status9 = binaryToDecimal(int(vs9[0]))
        ...
        tag_vol9 = binaryToDecimal(int(vs9[2] + vs9[1]))
        target_volatge_from_car9 = (tag_vol9 / 10)

        tag_curr9 = binaryToDecimal(int(vs9[4] + vs9[3]))
        target_current_from_car9 = (tag_curr9 / 10)
    
        target_power9 = int(target_volatge_from_car9 * target_current_from_car9)
        self._global_data.set_data_targetpower_ev9(target_power9)
        ...
        if vehicle_status2 == 13 and vehicle_status1_g == 0 or vehicle_status2 == 13 and vehicle_status1_g == 6:
            PECC.STATUS1_GUN2_DATA[2] = binaryToDecimal(int(vs9[2]))
            PECC.STATUS1_GUN2_DATA[1] = binaryToDecimal(int(vs9[1]))
            PECC.STATUS1_GUN2_DATA[3] = binaryToDecimal(int(vs9[3]))
            PECC.STATUS1_GUN2_DATA[4] = binaryToDecimal(int(vs9[4]))
            ...
            if 0 < maxpowerev2_g <= 30000:
                ...
                cable_check_voltage2 = binaryToDecimal(int(vs9[7] + vs9[6]))
