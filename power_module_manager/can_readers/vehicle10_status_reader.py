...
class Vehicle10StatusReader(BaseReader):
    arbitration_id = 2561
    ...
    def read_input_data(self):
        ...
        vs10 = self._binary_data
        self._global_data.set_data_status_vehicle10(binaryToDecimal(int(vs10[0])))
        vehicle_status10 = binaryToDecimal(int(vs10[0]))
        ...
        tag_vol10 = binaryToDecimal(int(vs10[2] + vs10[1]))
        target_volatge_from_car10 = (tag_vol10 / 10)

        tag_curr10 = binaryToDecimal(int(vs10[4] + vs10[3]))
        target_current_from_car10 = (tag_curr10 / 10)
     
        target_power10 = int(target_volatge_from_car10 * target_current_from_car10)
        self._global_data.set_data_targetpower_ev10(target_power10)
        ...
        if vehicle_status2 == 13 and vehicle_status1_g == 0 or vehicle_status2 == 13 and vehicle_status1_g == 6:
            PECC.STATUS1_GUN2_DATA[2] = binaryToDecimal(int(vs10[2]))
            PECC.STATUS1_GUN2_DATA[1] = binaryToDecimal(int(vs10[1]))
            PECC.STATUS1_GUN2_DATA[3] = binaryToDecimal(int(vs10[3]))
            PECC.STATUS1_GUN2_DATA[4] = binaryToDecimal(int(vs10[4]))
            ...
            if 0 < maxpowerev2_g <= 30000:
                ...
                cable_check_voltage2 = binaryToDecimal(int(vs10[7] + vs10[6]))
