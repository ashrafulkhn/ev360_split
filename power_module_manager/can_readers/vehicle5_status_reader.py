...
class Vehicle5StatusReader(BaseReader):
    arbitration_id = 1281
    ...
    def read_input_data(self):
        ...
        vs5 = self._binary_data
        self._global_data.set_data_status_vehicle5(binaryToDecimal(int(vs5[0])))
        vehicle_status5 = binaryToDecimal(int(vs5[0]))
        ...
        tag_vol5 = binaryToDecimal(int(vs5[2] + vs5[1]))
        target_volatge_from_car5 = (tag_vol5 / 10)

        tag_curr5 = binaryToDecimal(int(vs5[4] + vs5[3]))
        target_current_from_car5 = (tag_curr5 / 10)
        
        target_power5 = int(target_volatge_from_car5 * target_current_from_car5)
        self._global_data.set_data_targetpower_ev5(target_power5)
        ...
        if vehicle_status2 == 13 and vehicle_status1_g == 0 or vehicle_status2 == 13 and vehicle_status1_g == 6:
            PECC.STATUS1_GUN2_DATA[2] = binaryToDecimal(int(vs5[2]))
            PECC.STATUS1_GUN2_DATA[1] = binaryToDecimal(int(vs5[1]))
            PECC.STATUS1_GUN2_DATA[3] = binaryToDecimal(int(vs5[3]))
            PECC.STATUS1_GUN2_DATA[4] = binaryToDecimal(int(vs5[4]))
            ...
            if 0 < maxpowerev2_g <= 30000:
                ...
                cable_check_voltage2 = binaryToDecimal(int(vs5[7] + vs5[6]))
