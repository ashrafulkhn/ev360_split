...
class Vehicle12StatusReader(BaseReader):
    arbitration_id = 3073
    ...
    def read_input_data(self):
        ...
        vs12 = self._binary_data
        self._global_data.set_data_status_vehicle12(binaryToDecimal(int(vs12[0])))
        vehicle_status12 = binaryToDecimal(int(vs12[0]))
        ...
        tag_vol12 = binaryToDecimal(int(vs12[2] + vs12[1]))
        target_volatge_from_car12 = (tag_vol12 / 10)

        tag_curr12 = binaryToDecimal(int(vs12[4] + vs12[3]))
        target_current_from_car12 = (tag_curr12 / 10)
        
        target_power12 = int(target_volatge_from_car12 * target_current_from_car12)
        self._global_data.set_data_targetpower_ev12(target_power12)
        ...
        if vehicle_status2 == 13 and vehicle_status1_g == 0 or vehicle_status2 == 13 and vehicle_status1_g == 6:
            PECC.STATUS1_GUN2_DATA[2] = binaryToDecimal(int(vs12[2]))
            PECC.STATUS1_GUN2_DATA[1] = binaryToDecimal(int(vs12[1]))
            PECC.STATUS1_GUN2_DATA[3] = binaryToDecimal(int(vs12[3]))
            PECC.STATUS1_GUN2_DATA[4] = binaryToDecimal(int(vs12[4]))
            ...
            if 0 < maxpowerev2_g <= 30000:
                ...
                cable_check_voltage2 = binaryToDecimal(int(vs12[7] + vs12[6]))
