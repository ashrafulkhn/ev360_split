...
class Vehicle7StatusReader(BaseReader):
    arbitration_id = 1793
    ...
    def read_input_data(self):
        ...
        vs7 = self._binary_data
        self._global_data.set_data_status_vehicle7(binaryToDecimal(int(vs7[0])))
        vehicle_status7 = binaryToDecimal(int(vs7[0]))
        ...
        tag_vol7 = binaryToDecimal(int(vs7[2] + vs7[1]))
        target_volatge_from_car7 = (tag_vol7 / 10)

        tag_curr7 = binaryToDecimal(int(vs7[4] + vs7[3]))
        target_current_from_car2 = (tag_curr7 / 10)
        
        target_power7 = int(target_volatge_from_car7 *  target_current_from_car7 )
        self._global_data.set_data_targetpower_ev7(target_power7)
        ...
        if vehicle_status2 == 13 and vehicle_status1_g == 0 or vehicle_status2 == 13 and vehicle_status1_g == 6:
            PECC.STATUS1_GUN2_DATA[2] = binaryToDecimal(int(vs7[2]))
            PECC.STATUS1_GUN2_DATA[1] = binaryToDecimal(int(vs7[1]))
            PECC.STATUS1_GUN2_DATA[3] = binaryToDecimal(int(vs7[3]))
            PECC.STATUS1_GUN2_DATA[4] = binaryToDecimal(int(vs7[4]))
            ...
            if 0 < maxpowerev2_g <= 30000:
                ...
                cable_check_voltage2 = binaryToDecimal(int(vs7[7] + vs7[6]))
