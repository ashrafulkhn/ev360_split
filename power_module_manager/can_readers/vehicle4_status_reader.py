...
class Vehicle4StatusReader(BaseReader):
    arbitration_id = 1025
    ...
    def read_input_data(self):
        ...
        vs4 = self._binary_data
        self._global_data.set_data_status_vehicle4(binaryToDecimal(int(vs4[0])))
        vehicle_status4 = binaryToDecimal(int(vs4[0]))
        ...
        tag_vol4 = binaryToDecimal(int(vs4[2] + vs4[1]))
        target_volatge_from_car4 = (tag_vol4 / 10)

        tag_curr4 = binaryToDecimal(int(vs4[4] + vs4[3]))
        target_current_from_car4 = (tag_curr4 / 10)
    
        target_power4 = int(target_volatge_from_car4 * target_current_from_car4)
        self._global_data.set_data_targetpower_ev4(target_power4)
        ...
        if vehicle_status2 == 13 and vehicle_status1_g == 0 or vehicle_status2 == 13 and vehicle_status1_g == 6:
            PECC.STATUS1_GUN2_DATA[2] = binaryToDecimal(int(vs4[2]))
            PECC.STATUS1_GUN2_DATA[1] = binaryToDecimal(int(vs4[1]))
            PECC.STATUS1_GUN2_DATA[3] = binaryToDecimal(int(vs4[3]))
            PECC.STATUS1_GUN2_DATA[4] = binaryToDecimal(int(vs4[4]))
            ...
            if 0 < maxpowerev2_g <= 30000:
                ...
                cable_check_voltage2 = binaryToDecimal(int(vs4[7] + vs4[6]))
