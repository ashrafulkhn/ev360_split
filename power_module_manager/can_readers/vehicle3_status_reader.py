...
class Vehicle3StatusReader(BaseReader):
    arbitration_id = 769
    ...
    def read_input_data(self):
        ...
        vs3 = self._binary_data
        self._global_data.set_data_status_vehicle3(binaryToDecimal(int(vs3[0])))
        vehicle_status2 = binaryToDecimal(int(vs3[0]))
        ...
        tag_vol3 = binaryToDecimal(int(vs3[2] + vs3[1]))
        target_volatge_from_car3 = (tag_vol3 / 10)

        tag_curr3 = binaryToDecimal(int(vs3[4] + vs3[3]))
        target_current_from_car3 = (tag_curr3 / 10)
      
        target_power3 = int(target_volatge_from_car3 * target_current_from_car3)
        self._global_data.set_data_targetpower_ev3(target_power3)
        ...
        if vehicle_status2 == 13 and vehicle_status1_g == 0 or vehicle_status2 == 13 and vehicle_status1_g == 6:
            PECC.STATUS1_GUN2_DATA[2] = binaryToDecimal(int(vs3[2]))
            PECC.STATUS1_GUN2_DATA[1] = binaryToDecimal(int(vs3[1]))
            PECC.STATUS1_GUN2_DATA[3] = binaryToDecimal(int(vs3[3]))
            PECC.STATUS1_GUN2_DATA[4] = binaryToDecimal(int(vs3[4]))
            ...
            if 0 < maxpowerev2_g <= 30000:
                ...
                cable_check_voltage2 = binaryToDecimal(int(vs3[7] + vs3[6]))
