# from can_readers.digital_input_reader import DigitalInputReader
from can_readers.power_module_reader import PMSetDataCurrentPeccStatus1, PMSetDataCurrentPeccStatus2, PMSetDataCurrentPeccStatus3, \
